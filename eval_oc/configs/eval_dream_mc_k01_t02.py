"""Keep 0.1 at temperature 0.2 -- the multiple-choice half of our row.
...
Distinct from eval_dream_mc_k01.py, which is the greedy (``temperature=0``)
...
MMLU is excluded as before: 14042 questions against 3201 for the other three.
    ...
    FUTURE_DLLM_STUDENT=<checkpoint-best> scripts/run_oc_mc.sh k01-t02
"""
...
models = [
    dict(_base, abbr='dream-ours-k0.1-t0.2', keep_ratio=0.1,
...
work_dir = 'outputs/oc_dream_mc_k01_t02'
