"""Sparse-dLLM on LLaDA at keep_ratio 0.2, the multiple-choice suite.
...
models = [dict(m, abbr='llada-sparse-k0.2', keep_ratio=0.2)
          for m in models if m['abbr'] == 'llada-sparse-k0.5']

work_dir = 'outputs/oc_llada_sparse_k02'
