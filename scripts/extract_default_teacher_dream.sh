...
PY="${PY:-python}"
# Dream runs at 2048 total. HKUNLP/Dream's README states "the context length
# (input+output) of Dream currently is 2048". The config advertises
# max_position_embeddings=131072, but every length-related field there is
# identical to Qwen2.5-7B's, whose weights Dream was initialised from -- it is
# an inherited value, not a trained context. Sparse-dLLM evaluates at 2048 too.
